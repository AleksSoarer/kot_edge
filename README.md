...
Версия 0.8.1 открывает после входа в графическую сессию одно обычное окно
...
активной вкладкой и получает 10 секунд на регистрацию MPRIS, затем открывается
Кот и становится видимой вкладкой. Для музыкальной вкладки отключается
фоновый throttling Chromium. Скрипт также ждёт локальный порт Кота до 60 секунд,
чтобы при загрузке системы его вкладка не открылась со страницей ошибки.
